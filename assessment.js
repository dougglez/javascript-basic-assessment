...
setTimeout(console.log(messageObj, 3000));
// #14 Create a function called coderTest that takes in an object that is a person. It looks to see if the person’s name
//is Jeremy and then changes the person object to have a property called lovesCode with a value of 10.
...
function outside(temp, hum, clouds) {
	...
	else if (temp > 80 && hum < 40 && clouds < 20) {
		return "I'm literally in the desert";
	}
	else if (temp > 80 || hum > 50 || clouds > 50) {
